...
namespace PNotesNETShortcutManager
{
    internal class PNShellLink : IDisposable
    {
        ...
        {
            get { return m_ShortcutFile; }
            set { m_ShortcutFile = value; }
        }
        ...
        public void Save()
        {
            ...
            if (_linkA == null)
            {
                ((IPersistFile)_linkW).Save(m_ShortcutFile, true);
            }
            else
            {
                ((IPersistFile)_linkA).Save(m_ShortcutFile, true);
            }
        }
    }
}
