...
namespace PNotes.NET.styles
{
    ...
    public partial class CustomWindowStyle
    {
        ...
        public static readonly DependencyProperty HideMinButtonProperty =
            DependencyProperty.RegisterAttached("HideMinButton", typeof(bool), typeof(CustomWindowStyle),
                new UIPropertyMetadata(false));

        public static readonly DependencyProperty HideMaxButtonProperty =
            DependencyProperty.RegisterAttached("HideMaxButton", typeof(bool), typeof(CustomWindowStyle),
                new UIPropertyMetadata(false));

        public static bool GetHideMaxButton(DependencyObject obj)
        {
            return (bool)obj.GetValue(HideMaxButtonProperty);
        }

        public static void SetHideMaxButton(DependencyObject obj, bool value)
        {
            obj.SetValue(HideMaxButtonProperty, value);
        }

        public static bool GetHideMinButton(DependencyObject obj)
        {
            return (bool) obj.GetValue(HideMinButtonProperty);
        }

        public static void SetHideMinButton(DependencyObject obj, bool value)
        {
            obj.SetValue(HideMinButtonProperty, value);
        }

        public static CustomWindowBorderStyle GetWindowBorder(DependencyObject obj)
        {
            return (CustomWindowBorderStyle)obj.GetValue(WindowBorderProperty);
        }

        public static void SetWindowBorder(DependencyObject obj, CustomWindowBorderStyle value)
        {
            obj.SetValue(WindowBorderProperty, value);
        }
        ...
        void OnSizeEast(object sender, MouseButtonEventArgs e) { OnSize(sender, ((FrameworkElement)sender).FlowDirection == FlowDirection.LeftToRight ? SizingAction.East : SizingAction.West); }
        void OnSizeWest(object sender, MouseButtonEventArgs e) { OnSize(sender, ((FrameworkElement)sender).FlowDirection == FlowDirection.LeftToRight ? SizingAction.West : SizingAction.East); }
        void OnSizeNorthWest(object sender, MouseButtonEventArgs e) { OnSize(sender, ((FrameworkElement)sender).FlowDirection == FlowDirection.LeftToRight ? SizingAction.NorthWest : SizingAction.NorthEast); }
        void OnSizeNorthEast(object sender, MouseButtonEventArgs e) { OnSize(sender, ((FrameworkElement)sender).FlowDirection == FlowDirection.LeftToRight ? SizingAction.NorthEast : SizingAction.NorthWest); }
        void OnSizeSouthEast(object sender, MouseButtonEventArgs e) { OnSize(sender, ((FrameworkElement)sender).FlowDirection == FlowDirection.LeftToRight ? SizingAction.SouthEast : SizingAction.SouthWest); }
        void OnSizeSouthWest(object sender, MouseButtonEventArgs e) { OnSize(sender, ((FrameworkElement)sender).FlowDirection == FlowDirection.LeftToRight ? SizingAction.SouthWest : SizingAction.SouthEast); }
