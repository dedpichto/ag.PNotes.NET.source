...
namespace PNotes.NET
{
    ...
    public partial class WndCanvas
    {
        ...
        private void lineMenuClick(MenuItem menu)
        {
            try
            {
                    ...
                    case CommandType.Dummy:
                        switch (e.Parameter?.ToString())
                        {
                            ...
                            case "cmdLine":
                                ...
                                break;
                            case "mnuLine1":
                                lineMenuClick(mnuLine1);
                                break;
                            case "mnuLine2":
                                lineMenuClick(mnuLine2);
                                break;
                            case "mnuLine4":
                                lineMenuClick(mnuLine4);
                                break;
                            case "mnuLine6":
                                lineMenuClick(mnuLine6);
                                break;
                            case "mnuLine8":
                                lineMenuClick(mnuLine8);
                                break;
                        }
                        break;
                }
