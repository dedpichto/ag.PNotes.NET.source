...
namespace PNotes.NET
{
    internal class NoteConverter : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            if (str != null)
            {
                ...
                if (values.Length == Enum.GetValues(typeof(Fields)).Length)
                {
                    ...
                    var dateFromString = dtc.ConvertFromString(null, PNRuntimes.Instance.CultureInvariant, values[(int)Fields.DateCreated]);
                    if (dateFromString != null)
                        note.DateCreated = (DateTime)dateFromString;
                    dateFromString = dtc.ConvertFromString(null, PNRuntimes.Instance.CultureInvariant, values[(int)Fields.DateDeleted]);
                    if (dateFromString != null)
                        note.DateDeleted = (DateTime)dateFromString;
                    dateFromString = dtc.ConvertFromString(null, PNRuntimes.Instance.CultureInvariant, values[(int)Fields.DateReceived]);
                    if (dateFromString != null)
                        note.DateReceived = (DateTime)dateFromString;
                    dateFromString = dtc.ConvertFromString(null, PNRuntimes.Instance.CultureInvariant, values[(int)Fields.DateSaved]);
                    if (dateFromString != null)
                        note.DateSaved = (DateTime)dateFromString;
                    dateFromString = dtc.ConvertFromString(null, PNRuntimes.Instance.CultureInvariant, values[(int)Fields.DateSent]);
                    if (dateFromString != null)
                        note.DateSent = (DateTime)dateFromString;
                    note.DockStatus = (DockStatus)Convert.ToInt32(values[(int)Fields.DockStatus]);
                    var sizeFromString = scd.ConvertFromString(null, PNRuntimes.Instance.CultureInvariant, values[(int)Fields.EditSize]);
                    ...
                    var convertFromString = ptc.ConvertFromString(null, PNRuntimes.Instance.CultureInvariant, values[(int)Fields.NoteLocation]);
                    if (convertFromString != null)
                        note.NoteLocation = (Point)convertFromString;
                    var fromString = szc.ConvertFromString(null, PNRuntimes.Instance.CultureInvariant, values[(int)Fields.NoteSize]);
                    if (fromString != null)
                        note.NoteSize = (System.Windows.Size)fromString;
                    note.Opacity = Convert.ToDouble(values[(int)Fields.Opacity], PNRuntimes.Instance.CultureInvariant);
                    ...
                    note.XFactor = Convert.ToDouble(values[(int)Fields.XFactor], PNRuntimes.Instance.CultureInvariant);
                    note.YFactor = Convert.ToDouble(values[(int)Fields.YFactor], PNRuntimes.Instance.CultureInvariant);
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            sb.Append(DEL_NOTE);
            sb.Append(dtc.ConvertToString(null, PNRuntimes.Instance.CultureInvariant, note.DateCreated));
            sb.Append(DEL_NOTE);
            sb.Append(dtc.ConvertToString(null, PNRuntimes.Instance.CultureInvariant, note.DateDeleted));
            sb.Append(DEL_NOTE);
            sb.Append(dtc.ConvertToString(null, PNRuntimes.Instance.CultureInvariant, note.DateReceived));
            sb.Append(DEL_NOTE);
            sb.Append(dtc.ConvertToString(null, PNRuntimes.Instance.CultureInvariant, note.DateSaved));
            sb.Append(DEL_NOTE);
            sb.Append(dtc.ConvertToString(null, PNRuntimes.Instance.CultureInvariant, note.DateSent));
            sb.Append(DEL_NOTE);
            ...
            sb.Append(note.Name);
            sb.Append(DEL_NOTE);
            sb.Append(ptc.ConvertToString(null, PNRuntimes.Instance.CultureInvariant, note.NoteLocation));
            sb.Append(DEL_NOTE);
            sb.Append(szc.ConvertToString(null, PNRuntimes.Instance.CultureInvariant, note.NoteSize));
            sb.Append(DEL_NOTE);
            ...
            sb.Append(DEL_NOTE);
            sb.Append(note.XFactor.ToString(PNRuntimes.Instance.CultureInvariant));
            sb.Append(DEL_NOTE);
            sb.Append(note.YFactor.ToString(PNRuntimes.Instance.CultureInvariant));
            sb.Append(DEL_NOTE);
    ...
    internal class SkinlessConverter : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            try
            {
                convertFromString = cr.ConvertFromString(null, PNRuntimes.Instance.CultureInvariant, values[0]);
                if (convertFromString != null)
            ...
            catch (FormatException)
            {
                ...
                convertFromString = drawingColorConverter.ConvertFromString(null, PNRuntimes.Instance.CultureInvariant,
                    values[0]);
                if (convertFromString != null)
                {
            ...
            try
            {
                convertFromString = cr.ConvertFromString(null, PNRuntimes.Instance.CultureInvariant, values[1]);
                if (convertFromString != null)
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            var sb = new StringBuilder();
            sb.Append(cr.ConvertToString(null, PNRuntimes.Instance.CultureInvariant, skl.BackColor));
            sb.Append(DEL_INNER);
            sb.Append(cr.ConvertToString(null, PNRuntimes.Instance.CultureInvariant, skl.CaptionColor));
            sb.Append(DEL_INNER);
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            if (str != null)
            {
                ...
                if (values.Length == Enum.GetValues(typeof(Fields)).Length)
                {
                    ...
                    var dateFromString = dtc.ConvertFromString(null, PNRuntimes.Instance.CultureInvariant, values[(int)Fields.AlarmDate]);
                    if (dateFromString != null)
                        sch.AlarmDate = (DateTime)dateFromString;
                    dateFromString = dtc.ConvertFromString(null, PNRuntimes.Instance.CultureInvariant, values[(int)Fields.LastRun]);
                    if (dateFromString != null)
                    ...
                    dateFromString = dtc.ConvertFromString(null, PNRuntimes.Instance.CultureInvariant, values[(int)Fields.StartDate]);
                    if (dateFromString != null)
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            if (destinationType == typeof(string))
            {
                ...
                if (sch != null)
                {
                    ...
                    sb.Append(DEL_INNER);
                    sb.Append(dtc.ConvertToString(null, PNRuntimes.Instance.CultureInvariant, sch.AlarmDate));
                    sb.Append(DEL_INNER);
                    sb.Append(dtc.ConvertToString(null, PNRuntimes.Instance.CultureInvariant, sch.LastRun));
                    sb.Append(DEL_INNER);
                    ...
                    sb.Append(DEL_INNER);
                    sb.Append(dtc.ConvertToString(null, PNRuntimes.Instance.CultureInvariant, sch.StartDate));
                    sb.Append(DEL_INNER);
    ...
    internal class DaysOfWeekConverter : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            if (str != null)
            {
                ...
                {
                    list.AddRange(values.Select(t => (DayOfWeek)int.Parse(t, PNRuntimes.Instance.CultureInvariant)));
                }
                return list;
            }
            return base.ConvertFrom(context, culture, value);
    ...
    internal class MonthDayConverter : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            {
                var v = s.Split(',');
                return new MonthDay { WeekDay = (DayOfWeek)int.Parse(v[0], PNRuntimes.Instance.CultureInvariant), OrdinalNumber = (DayOrdinal)int.Parse(v[1], PNRuntimes.Instance.CultureInvariant) };
            }
            return base.ConvertFrom(context, culture, value);
        }
    ...
    internal class AlarmAfterValuesConverter : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            {
                var v = s.Split(',');
                return new AlarmAfterValues { Years = int.Parse(v[0], PNRuntimes.Instance.CultureInvariant), Months = int.Parse(v[1], PNRuntimes.Instance.CultureInvariant), Weeks = int.Parse(v[2], PNRuntimes.Instance.CultureInvariant), Days = int.Parse(v[3], PNRuntimes.Instance.CultureInvariant), Hours = int.Parse(v[4], PNRuntimes.Instance.CultureInvariant), Minutes = int.Parse(v[5], PNRuntimes.Instance.CultureInvariant), Seconds = int.Parse(v[6], PNRuntimes.Instance.CultureInvariant) };
            }
            return base.ConvertFrom(context, culture, value);
        }
    ...
    internal class BaloonProgressVisibilityConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (!(value is BaloonMode)) return Visibility.Collapsed;
            var mode = (BaloonMode)value;
            switch (mode)
            {
                case BaloonMode.Sending:
    ...
    internal class BaloonImageVisibilityConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (!(value is BaloonMode)) return Visibility.Collapsed;
    ...
    internal class TextLengthToEEnabledConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
    ...
    internal class EnabledToSmallButtonColorConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var fe = new FrameworkElement();
            return (bool)value ? 1.0 : fe.TryFindResource("DisabledOpacity");
        }
    ...
    internal class AutoHideToAngleConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            return PNRuntimes.Instance.Settings.Behavior.PanelAutoHide ? 0 : -90;
        }
    ...
    internal class OrientationToAngleConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            return PNRuntimes.Instance.Settings.Behavior.NotesPanelOrientation == NotesPanelOrientation.Left ? 0 : -90;
        }
    ...
    internal class TooltipForImageConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                case "imgAutoHide":
                    return PNRuntimes.Instance.Settings.Behavior.PanelAutoHide
    ...
    internal class ConnectionCheckConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            if (values.Length < 3 || !(values[0] is bool) || !(values[1] is decimal) || !(values[2] is bool))
                return false;
            return (bool)values[0] && (decimal)values[1] > 0 && !(bool)values[2];
        }
    ...
    internal class CursorFlowConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (!(value is FlowDirection) || !(parameter is string))
                return Cursors.Arrow;
            switch ((string)parameter)
            {
                case "gripSize":
                case "rectSizeNorthWest":
                    return (FlowDirection)value == FlowDirection.LeftToRight ? Cursors.SizeNWSE : Cursors.SizeNESW;
                case "rectSizeSouthWest":
                case "rectSizeNorthEast":
                    return (FlowDirection)value == FlowDirection.LeftToRight ? Cursors.SizeNESW : Cursors.SizeNWSE;
            }
            return Cursors.Arrow;
        }
