...
namespace PNotes.NET
{
    internal class PNRegistry
    {
        ...
        {
            var productName = getLocalMachineString(@"SOFTWARE\Microsoft\Windows NT\CurrentVersion", "ProductName");
            var csdVersion = getLocalMachineString(@"SOFTWARE\Microsoft\Windows NT\CurrentVersion", "CSDVersion");
            if (productName == "") return "";
            var name = (productName.StartsWith("Microsoft") ? "" : "Microsoft ") + productName +
        ...
        private static string getLocalMachineString(string path, string key)
        {
            try
            {
