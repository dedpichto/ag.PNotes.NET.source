...
namespace PNotes.NET
{
    ...
    public partial class SkinlessHeader : IHeader
    {
        ...
        {
            e.Handled = true;
            HeaderButtonClicked?.Invoke(this, new HeaderButtonClickedEventArgs(HeaderButtonType.Hide));
        }

        private void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            e.Handled = true;
            HeaderButtonClicked?.Invoke(this, new HeaderButtonClickedEventArgs(HeaderButtonType.Delete));
        }
        ...
        {
            e.Handled = true;
            HeaderButtonClicked?.Invoke(this, new HeaderButtonClickedEventArgs(HeaderButtonType.Panel));
        }
    }

    internal class HeaderButtonClickedEventArgs : EventArgs
    {
        internal HeaderButtonType ButtonType { get; }
