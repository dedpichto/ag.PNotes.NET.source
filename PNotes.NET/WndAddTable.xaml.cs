...
namespace PNotes.NET
{
    ...
    {
        internal event EventHandler<CustomRtfReadyEventArgs> TableReady;

        private class TableBorderThickness
        {
        ...
        private void initializeEdit()
        {
            try
            {
                ...
                _Edit.ReadOnly = true;
                if (!(brdHost.Background is SolidColorBrush brush)) return;
        ...
        private void prepareRtf(bool example)
        {
            try
            {
                ...
                if (cboTableBorders.SelectedItem is TableBorderThickness thickness)
                {
        ...
        private void DlgAddTable_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                cboTableBorders.Items.Add(new TableBorderThickness { Text = "0", Value = 0 });
                cboTableBorders.Items.Add(new TableBorderThickness { Text = "1", Value = 1 });
                cboTableBorders.Items.Add(new TableBorderThickness { Text = "2", Value = 3 });
                cboTableBorders.Items.Add(new TableBorderThickness { Text = "3", Value = 4 });
                cboTableBorders.Items.Add(new TableBorderThickness { Text = "4", Value = 6 });
                cboTableBorders.Items.Add(new TableBorderThickness { Text = "5", Value = 7 });
                cboTableBorders.Items.Add(new TableBorderThickness { Text = "6", Value = 9 });
                cboTableBorders.Items.Add(new TableBorderThickness { Text = "7", Value = 10 });
        ...
        private void oKClick()
        {
            try
            {
                ...
                {
                    prepareRtf(false);
                    TableReady?.Invoke(this, new CustomRtfReadyEventArgs(_Rtf.ToString()));
                }
                DialogResult = true;
            }
            catch (Exception ex)
