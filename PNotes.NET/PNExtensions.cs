...
namespace PNotes.NET
{
    internal static class PNExtensions
    {
        ...
        {
            Brush result;
            if (original is SolidColorBrush solidColorBrush)
            {
            ...
            {
                if (original is LinearGradientBrush gradientBrush)
                {
                    result = gradientBrush.Clone();
                    foreach (var gs in ((GradientBrush)result).GradientStops)
                    {
        ...
        internal static bool IsDate(this string str)
        {
        ...
        {
            if (PNRuntimes.Instance.Settings.GeneralSettings.DateBits[DatePart.Year] && d1.Year != d2.Year)
                return false;
            if (PNRuntimes.Instance.Settings.GeneralSettings.DateBits[DatePart.Month] && d1.Month != d2.Month)
                return false;
            if (PNRuntimes.Instance.Settings.GeneralSettings.DateBits[DatePart.Day] && d1.Day != d2.Day)
                return false;
            if (PNRuntimes.Instance.Settings.GeneralSettings.DateBits[DatePart.Hour] && d1.Hour != d2.Hour)
                return false;
            if (PNRuntimes.Instance.Settings.GeneralSettings.DateBits[DatePart.Minute] && d1.Minute != d2.Minute)
                return false;
            if (PNRuntimes.Instance.Settings.GeneralSettings.DateBits[DatePart.Second] && d1.Second != d2.Second)
                return false;
            if (PNRuntimes.Instance.Settings.GeneralSettings.DateBits[DatePart.Millisecond] && d1.Millisecond != d2.Millisecond)
                return false;
            return true;
        }
        ...
        {
            if (PNRuntimes.Instance.Settings.GeneralSettings.TimeBits[DatePart.Hour] && t1.Hour != t2.Hour)
                return false;
            if (PNRuntimes.Instance.Settings.GeneralSettings.TimeBits[DatePart.Minute] && t1.Minute != t2.Minute)
                return false;
            if (PNRuntimes.Instance.Settings.GeneralSettings.TimeBits[DatePart.Second] && t1.Second != t2.Second)
                return false;
            if (PNRuntimes.Instance.Settings.GeneralSettings.TimeBits[DatePart.Millisecond] && t1.Millisecond != t2.Millisecond)
                return false;
            return true;
        }
        ...
        internal static bool IsTimeMore(this DateTime t1, DateTime t2)
        {
            ...
            if (PNRuntimes.Instance.Settings.GeneralSettings.TimeBits[DatePart.Hour])
            {
                tf = tf.AddHours(t1.Hour);
                tt = tt.AddHours(t2.Hour);
            }
            if (PNRuntimes.Instance.Settings.GeneralSettings.TimeBits[DatePart.Minute])
            {
                tf = tf.AddMinutes(t1.Minute);
                tt = tt.AddMinutes(t2.Minute);
            }
            if (PNRuntimes.Instance.Settings.GeneralSettings.TimeBits[DatePart.Second])
            {
                tf = tf.AddSeconds(t1.Second);
                tt = t2.AddSeconds(t2.Second);
            }
            if (PNRuntimes.Instance.Settings.GeneralSettings.TimeBits[DatePart.Millisecond])
            {
